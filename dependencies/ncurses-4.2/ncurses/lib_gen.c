...
int attroff ( int z)
{
	T((T_CALLED("attroff(%s)"), _traceattr2(0,z))); returnCode( wattr_off(stdscr, z));
}
...
int attron ( int z)
{
	T((T_CALLED("attron(%s)"), _traceattr2(0,z))); returnCode( wattr_on(stdscr, z));
}
...
int attr_get ( void)
{
	T((T_CALLED("attr_get()"))); returnCode( ((stdscr)->_attrs));
}
...
int attr_off ( int z)
{
	T((T_CALLED("attr_off(%s)"), _traceattr2(0,z))); returnCode( wattr_off(stdscr,z));
}
...
int attr_on ( int z)
{
	T((T_CALLED("attr_on(%s)"), _traceattr2(0,z))); returnCode( wattr_on(stdscr,z));
}
...
int attr_set ( int z)
{
	T((T_CALLED("attr_set(%s)"), _traceattr2(0,z))); returnCode( ((stdscr)?((stdscr)->_attrs = (z)):0));
}
...
#undef slk_attr_off
int slk_attr_off ( attr_t z)
{
	T((T_CALLED("slk_attr_off(%s)"), _traceattr2(0,z))); returnCode( slk_attroff(z));
}
#endif
...
#if USE_WIDEC_SUPPORT
#undef slk_attr_on
int slk_attr_on ( attr_t z)
{
	T((T_CALLED("slk_attr_on(%s)"), _traceattr2(0,z))); returnCode( slk_attron(z));
}
#endif
...
#if USE_WIDEC_SUPPORT
#undef slk_attr_set
int slk_attr_set ( attr_t z)
{
	T((T_CALLED("slk_attr_set(%s)"), _traceattr2(0,z))); returnCode( slk_attrset(z));
}
#endif
...
int timeout ( int z)
{
	T((T_CALLED("timeout(%d)"), z)); returnCode( wtimeout(stdscr,z));
}
...
#if USE_WIDEC_SUPPORT
#undef vid_attr
int vid_attr ( attr_t z)
{
	T((T_CALLED("vid_attr(%s)"), _traceattr2(0,z))); returnCode( vidattr(z));
}
#endif
...
#undef vw_printw
int vw_printw ( WINDOW * a1, const char * a2, va_list z)
{
...
#undef vw_scanw
int vw_scanw ( WINDOW * a1, const char * a2, va_list z)
{
...
{
	T((T_CALLED("wattron(%p,%d)"), a1, z)); returnCode( wattr_on(a1, z));
}
...
{
	T((T_CALLED("wattroff(%p,%d)"), a1, z)); returnCode( wattr_off(a1, z));
}
...
#undef wattr_get
attr_t wattr_get ( WINDOW * z)
{
	T((T_CALLED("wattr_get(%p)"), z)); returnCode( ((z)->_attrs));
}


#undef wattr_set
int wattr_set ( WINDOW * a1, attr_t z)
{
	T((T_CALLED("wattr_set(%p,%s)"), a1, _traceattr2(1,z))); returnCode( ((a1)?((a1)->_attrs = (z)):0));
}
