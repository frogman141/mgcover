...
s/TH \<curs_scr_dmp 3X ""/TH scr_dump 3NCURSES ""/
...
s/TH \<dft_fgbg 3X ""/TH dft_fgbg 3NCURSES ""/
...
s/TH \<menu_attribs 3X ""/TH attribs 3MENU ""/
...
s/\<fBcurs_scr_dmp\\fR(3X)/fBscr_dump\\fR(3NCURSES)/
...
s/\<fBdft_fgbg\\fR(3X)/fBdft_fgbg\\fR(3NCURSES)/
...
s/\<fBmenu_attribs\\fR(3X)/fBattribs\\fR(3MENU)/
