    ...
    if(argv[1]==string("analysis")){
        ...
        for(vector<char*>::iterator it = files.begin(); it != files.end(); ++it) {
            ...
            if(torrent==false){
                ...
                if(boost::regex_search(std::to_string(last_tile),tile_long4) and !is_hiseq_32 and !is_hiseq_48){
                     four_digits=true;
                ...
                }else if(boost::regex_search(std::to_string(last_tile),tile_long5) and !is_hiseq_32 and !is_hiseq_48){
                     five_digits=true;
                     int tile_ord=last_tile%100;
...
//            cout<<"Max r length: "<<max_read_length<<" N tiles: "<<number_of_tiles<<endl;
    ...
    if(argv[1]==string("lengthsort")){
        ...
        std::ofstream SINGLE (single_chr, std::ofstream::out);
        std::ofstream DISCARD (discard_chr, std::ofstream::out);
        ...
        if(paired==true){
            ...
            std::ofstream PAIRED1 (paired1_chr, std::ofstream::out);
            std::ofstream PAIRED2 (paired2_chr, std::ofstream::out);
